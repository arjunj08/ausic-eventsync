...
export default function OTPVerify() {
  ...
  const [mockOtp, setMockOtp] = useState(location.state?.mockOtp || '');
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col justify-center items-center px-6 py-12">
      <div className="max-w-md w-full bg-[#111111] border border-gray-800 rounded-2xl shadow-2xl p-8 relative">
        ...
        {/* Mock OTP Badge for Dev Testing */}
        {mockOtp && (
          <div className="mb-6 p-4 bg-[#7C3AED]/10 border border-[#7C3AED]/20 rounded-xl text-center space-y-1">
            <span className="text-[9px] text-[#8F5CFF] font-extrabold uppercase tracking-widest block">Developer Testing Mock Code</span>
            <span className="text-2xl font-black text-white tracking-widest">{mockOtp}</span>
          </div>
        )}
